...
const PayslipDetailPage = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div ref={printComponentRef} className="bg-white text-black p-12 shadow-lg rounded-md max-w-4xl mx-auto printable-area">
        {/* Document Header */}
        <div className="flex justify-between items-start pb-8 border-b-2 border-slate-200">
          <div>
            ...
            <p className="text-sm text-slate-500">{tenantProfile?.contactInfo?.address || "123 Main Street, Colombo"}</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-8 my-8">
          <div>
            ...
            <p className="text-slate-600">{employeeId.designation}</p>
