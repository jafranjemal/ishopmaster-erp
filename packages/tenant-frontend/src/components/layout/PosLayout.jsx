...
const PosTopBar = ({ onLayoutToggle, onToggleFullscreen, isFullscreen }) => {
...
const PosLayout = ({ children, onLayoutToggle }) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-900 text-slate-100">
      <ApplicationMenuBar />
      <PosTopBar onLayoutToggle={onLayoutToggle} onToggleFullscreen={handleToggleFullscreen} isFullscreen={isFullscreen} />
